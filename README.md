...
Contributions should make the supported descriptor compiler clearer, smaller, better tested, or more correct. Avoid adding product surfaces or USB classes before the core model needs them.
...
No license file is present yet. Until one is added, do not assume redistribution or reuse terms beyond normal repository viewing.
